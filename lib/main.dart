      ...
      body: PageView(
        ...
        children: <Widget>[
          makePage(
            ...
            title: 'MINISO',
            description: 'Somos una empresa que te brinda productos lindos, durables y de buena calidad '
          ),
          makePage(
            page: 2,
            image: 'assets/images/Dos.jpg',
            title: 'Peluches ',
            description: 'Contamos con una gran variedad de peluches'
          ),
          makePage(
            page: 3,
            image: 'assets/images/Tres.jpg',
            title: 'Productos',
            description: "Sedonerica's most beautiful places."
          ),
          makePage(
            page: 4,
